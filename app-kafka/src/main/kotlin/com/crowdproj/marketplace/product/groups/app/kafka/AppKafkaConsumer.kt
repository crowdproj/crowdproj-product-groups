...
interface ConsumerStrategy {
    ...
    fun serialize(source: ProductGroupContext): String
    fun deserialize(value: String, target: ProductGroupContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: ProductGroupProcessor = ProductGroupProcessor(),
    ...
    private fun sendResponse(context: ProductGroupContext, strategy: ConsumerStrategy, outputTopic: String) {
